package com.thisfeng.xlibrary.utils.LogUtil;
...
public class LogLayout {
    ...
    private void init() {
        rootView = (RelativeLayout) LayoutInflater.from(context).inflate(com.thisfeng.xlibrary.R.layout.layout_base_console_view, null);
