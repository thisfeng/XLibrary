package com.thisfeng.test.test.weiget;
...
import com.thisfeng.test.test.bean.TempBean;
        ...
        public void onViewDragStateChanged(int state) {
            if (state == ViewDragHelper.STATE_DRAGGING) {
                ...
                if (currentChangedView != null) {
                    LayoutParams layoutParams = new LayoutParams(currentChangedView.getLayoutParams());
