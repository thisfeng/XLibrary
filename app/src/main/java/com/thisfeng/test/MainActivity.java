...
import com.thisfeng.test.api.Api;
import com.thisfeng.xlibrary.adapter.CustomHolder;
import com.thisfeng.xlibrary.adapter.XAdapter;
import com.thisfeng.xlibrary.animation.SlideInBottomAnimation;
import com.thisfeng.xlibrary.annotation.SaveState;
import com.thisfeng.xlibrary.base.PhotoSelectBaseActivity;
import com.thisfeng.xlibrary.instance.FrescoLoader;
import com.thisfeng.xlibrary.okHttp.Header;
import com.thisfeng.xlibrary.okHttp.OkResponseListener;
import com.thisfeng.xlibrary.okHttp.Param;
import com.thisfeng.xlibrary.uiKit.recyclerview.FloatingBarItemDecoration;
import com.thisfeng.xlibrary.uiKit.views.MultiImageView;
import com.thisfeng.xlibrary.uiKit.views.loopview.AdLoopView;
import com.thisfeng.xlibrary.uiKit.views.nicespinner.NiceSpinner;
import com.thisfeng.xlibrary.unit.MsgEvent;
import com.thisfeng.xlibrary.unit.StringData;
import com.thisfeng.xlibrary.unit.UrlData;
import com.thisfeng.xlibrary.unit.ViewTypeUnit;
import com.thisfeng.xlibrary.unit.WH;
...
import com.thisfeng.xlibrary.utils.serverApiHelper.ServerControllerActivity;
import com.thisfeng.xlibrary.utils.toast.TS;
import com.thisfeng.xlibrary.xRefresher.RefreshRequest;
import com.thisfeng.xlibrary.xRefresher.XRefresher;
...
public class MainActivity extends ABaseActivity {
    ...
    private XAdapter<ListBean.ContentBean> adapter;
...
//        DrawerLayout drawerLayout = (DrawerLayout) getLayoutInflater().inflate(com.thisfeng.xlibrary.R.layout.layout_base_console_view, null);
...
//            adapter.setDataList(new ArrayList<>());
            ...
            newCall().url(Api.api().getSomeAddress)
 ...
 */
        FloatingBarItemDecoration floatingBarItemDecoration = new FloatingBarItemDecoration(getThis(), null,
                ...
                obj -> ((ListBean.ContentBean) obj).getPosterTitle());
        adapter = new XAdapter<ListBean.ContentBean>(this, () -> bean.getContent()) {

            @Override
            protected void beforeSetDataList(List<ListBean.ContentBean> dataList) {
                floatingBarItemDecoration.setList(dataList, adapter.getHeaderCount());
                super.beforeSetDataList(dataList);
            }

            @Override
            protected ViewTypeUnit getViewTypeUnitForLayout(ListBean.ContentBean item) {
                switch (item.getId()) {
                    case "1":
                        break;
                    default:
...
//                return new ViewTypeUnit(1, R.layout.list_item_text);
            ...
            @Override
            protected void handleItemViewClick(CustomHolder holder, ListBean.ContentBean item, int viewId, ViewTypeUnit viewTypeUnit) {
                switch (viewId) {
                    case R.id.tvName:
...
//                        TS.show(item.getAddress() + " YES " + viewId);
            ...
            @Override
            public void bindingHolder(CustomHolder holder, final List<ListBean.ContentBean> dataList, final int pos) {
                ListBean.ContentBean item = dataList.get(pos);
        ...
        /*    @Override
            protected void bindingFooterLoader(CustomHolder holder, int viewType) {
                if (viewType == XAdapter.LAYOUT_FOOTER_RETRY) {
                    holder.setText(com.thisfeng.xlibrary.R.id.tv, "哇哈哈！");
                }
            }*/
        };
...
//        adapter.setFooter(R.layout.footer);
        ...
        xRefresher.setup(this, adapter).setLoadMore()
           ...
           /* postForm("https://www.taichi-tiger.com:8080/append/app_poster/selectAllPosters", new Param(), false, new OkHttp.OkResponseListener() {
                ...
                }).setRefreshRequest(new RefreshRequest<ListBean.ContentBean>() {
            @Override
...
//                return "http://www.zhijia51.com/append/store_recommend/sell_house_page";
                return Api.api().getSomeAddress;
            }


            @Override
            public List<ListBean.ContentBean> setListData(JSONObject json) {
...
//            rl.setBackgroundColor(R.color.colorPrimary);
            ...
            siv.setImageURI(ImageUtils.getResUri(com.thisfeng.xlibrary.R.mipmap.loading));

            rl.addView(siv);
            ((ViewGroup) findViewById(R.id.ll)).addView(rl);

//            Animation animation = AnimationUtils.loadAnimation(getThis(), com.thisfeng.xlibrary.R.animator.rotate_loading);
